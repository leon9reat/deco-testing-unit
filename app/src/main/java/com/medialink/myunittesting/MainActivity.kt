            ...
            height.isEmpty() -> edtHeight.error = "field ini tidak boleh kosong"
                ...
                when {
                    ...
                    v.id == R.id.btn_calculate_circumference -> {
                        txtResult.text = mainViewModel.getCircumference().toString()
                        gone()
                    }
                    v.id == R.id.btn_calculate_surface_area -> {
                        txtResult.text = mainViewModel.getSurfaceArea().toString()
                        gone()
                    }
                    v.id == R.id.btn_calculate_volume -> {
                        txtResult.text = mainViewModel.getVolume().toString()
                        gone()
                    }
                }
            }
